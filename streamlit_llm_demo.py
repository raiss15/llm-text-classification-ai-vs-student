...
with st.sidebar:
    ...
    st.markdown(
        "🔍 **Model**: `bert-base-uncased` fine-tuned on the [LLM dataset](https://www.kaggle.com/datasets/prajwaldongre/llm-detect-ai-generated-vs-student-generated-text)"
    )
    st.markdown("👩‍💻 Built by Sohni Rais")

# Load model and tokenizer
model_path = "llm-detector"
